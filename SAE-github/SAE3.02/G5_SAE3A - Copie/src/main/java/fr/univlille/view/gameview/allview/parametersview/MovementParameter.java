...
public class MovementParameter extends View{
    ...
    public void start(){
        ...
        RadioButton movementEightWithoutPassingWall = new RadioButton("Mouvement en 8 (impossible de passer les mûrs)");
        RadioButton movementEightWithPassingWall = new RadioButton("Mouvement en 8 (possible de passer les mûrs)");

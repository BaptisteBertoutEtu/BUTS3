...
public class MenuView extends View{
    ...
    public void start(){
        ...
        bp.setPrefSize(MenuView.WIDTH, MenuView.HEIGHT-20);
        v.setPrefSize(MenuView.WIDTH, MenuView.HEIGHT-20);
        ...
        v.getChildren().addAll(play, modifyParameters,rules,exit);
        bp.setTop(title);
        bp.setCenter(v);
        bp.setBottom(author);
